...
import { View, Text, StyleSheet, TouchableOpacity, FlatList, TextInput, Switch, useWindowDimensions } from 'react-native';
...
export const RouteList: React.FC<RouteListProps> = ({
    ...
    return (
        <View style={styles.container}>
            <Text style={[styles.panelTitle, isSmallScreen && styles.panelTitleSmall]}>Routes ({routes.length})</Text>
            ...
            <View style={[styles.controls, isSmallScreen && styles.controlsSmall]}>
                <View style={styles.controlRow}>
                    <Text style={[styles.controlLabel, isSmallScreen && styles.controlLabelSmall]}>Current View Only</Text>
                    <Switch
                ...
                <View style={styles.controlRow}>
                    <Text style={[styles.controlLabel, isSmallScreen && styles.controlLabelSmall]}>Sort by:</Text>
            ...
            <FlatList
                ...
                renderItem={({ item }) => {
                    ...
                    return (
                        ...
                        >
                            <Text style={[styles.listItemTitle, isSmallScreen && styles.listItemTitleSmall]} numberOfLines={1}>
                                {item.name || 'Unnamed'}
                            </Text>
