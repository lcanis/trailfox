...
export default function Map({ onHover, onSelect, onViewChange, selectedId, highlightedId }: MapProps) {
    ...
    useEffect(() => {
        ...
        map.current.on('load', () => {
            ...
            map.current.on('click', (e) => {
                const features = map.current?.queryRenderedFeatures(e.point, { layers: ['routes-hit-area'] });
