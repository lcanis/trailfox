...
def test_split_single_way(grid, ways):
    ...
    assert route == rt.RouteSegment(
        ...
        main=[rt.WaySegment(
                length=5, start=0,
                ways=[rt.BaseWay(osm_id=1, tags={}, length=5, start=0,
              ...
              rt.SplitSegment(
                ...
                forward=[rt.WaySegment(
                            length=6, start=5,
                            ways=[rt.BaseWay(osm_id=11, tags={}, length=6, start=5,
                ...
                backward=[rt.WaySegment(
                            length=6, start=5,
                            ways=[rt.BaseWay(osm_id=12, tags={}, length=6, start=5,
              ...
              rt.WaySegment(
                length=5, start=11,
                ways=[rt.BaseWay(osm_id=3, tags={}, length=5, start=11,
    ...
    assert route == rt.RouteSegment(
        ...
        main=[rt.WaySegment(
              ...
              rt.SplitSegment(
                ...
                forward=[rt.WaySegment(
                            length=7, start=5,
                            ways=[rt.BaseWay(osm_id=11, tags={}, length=3, start=5,
                                             direction=1, role='', geom=g.line('123')
                                             ),
                                  rt.BaseWay(osm_id=21, tags={}, length=4, start=8,
                ...
                backward=[rt.WaySegment(
                            length=7, start=5,
                            ways=[rt.BaseWay(osm_id=22, tags={}, length=4, start=5,
                                             direction=-1, role='', geom=g.line('16')
                                             ),
                                  rt.BaseWay(osm_id=12, tags={}, length=3, start=9,
              ...
              rt.WaySegment(
                length=5, start=12,
                ways=[rt.BaseWay(osm_id=3, tags={}, length=5, start=12,
                                 direction=0, role='', geom=g.line('49')
                                 )
                     ]
                )
        ...
        main=[rt.WaySegment(
              ...
              rt.SplitSegment(
                ...
                forward=[rt.WaySegment(
                         ...
                         rt.WaySegment(
                            length=4, start=10,
                            ways=[rt.BaseWay(osm_id=21, tags={}, length=4, start=10,
                                             direction=1, role='', geom=g.line('34')
                                             )
                                 ]
                            )
              ...
              rt.WaySegment(
                length=5, start=14,
                ways=[rt.BaseWay(osm_id=3, tags={}, length=5, start=14,
                                 direction=0, role='', geom=g.line('49')
                                 )
                     ]
                )
              ...
              rt.SplitSegment(
                ...
                backward=[rt.WaySegment(
                          ...
                          rt.WaySegment(
                            length=3, start=11,
                            ways=[
                                  rt.BaseWay(osm_id=12, tags={}, length=3, start=11,
    ...
    assert route == rt.RouteSegment(
        ...
        main=[rt.WaySegment(
              ...
              rt.SplitSegment(
                ...
                forward=[rt.WaySegment(
                            length=7, start=7,
                            ways=[rt.BaseWay(osm_id=11, tags={}, length=3, start=7,
                                             direction=1, role='', geom=g.line('23')
                                             ),
                                  rt.BaseWay(osm_id=21, tags={}, length=4, start=10,
                                             direction=1, role='', geom=g.line('34')
                                             )
                                 ]
                            )
    ...
    assert route == rt.RouteSegment(
        ...
        main=[rt.WaySegment(
              ...
              rt.SplitSegment(
                ...
                backward=[rt.WaySegment(
                            length=7, start=7,
                            ways=[rt.BaseWay(osm_id=22, tags={}, length=4, start=7,
    ...
    assert route == rt.RouteSegment(
        ...
        main=[rt.WaySegment(
              ...
              rt.SplitSegment(
                ...
                backward=[rt.WaySegment(
                            length=7, start=9,
                            ways=[rt.BaseWay(osm_id=22, tags={}, length=4, start=9,
                                             direction=-1, role='', geom=g.line('65')
                                             ),
                                  rt.BaseWay(osm_id=12, tags={}, length=3, start=13,
                                             direction=-1, role='', geom=g.line('54')
                                             )
                                 ]
                            )
              ...
              rt.WaySegment(
                length=5, start=16,
                ways=[rt.BaseWay(osm_id=3, tags={}, length=5, start=16,
                                 direction=0, role='', geom=g.line('49')
                                 )
                     ]
                )
    ...
    assert route == rt.RouteSegment(
        ...
        main=[rt.WaySegment(
              ...
              rt.SplitSegment(
                ...
                forward=[rt.WaySegment(
                            length=7, start=7,
                            ways=[rt.BaseWay(osm_id=11, tags={}, length=7, start=7,
                                             direction=1, role='', geom=g.line('234')
                                             )
                                 ]
                            )
                ...
                backward=[rt.WaySegment(
                            length=7, start=9,
                            ways=[rt.BaseWay(osm_id=12, tags={}, length=7, start=9,
                                             direction=-1, role='', geom=g.line('654')
                                             )
                                 ]
                            )
...
def test_v_shape_with_dangling_oneway(grid):
    ...
    assert route == rt.RouteSegment(
        ...
        main=[rt.WaySegment(
                length=3, start=0,
                ways=[rt.BaseWay(osm_id=1, tags={}, length=3, start=0,
                                 direction=0, role='', geom=g.line('125'))
                     ]
                ),
              rt.WaySegment(
                length=4, start=3,
                ways=[rt.BaseWay(osm_id=2, tags={}, length=2, start=3,
                                 direction=1, role='', geom=g.line('56')),
                      rt.BaseWay(osm_id=12, tags={}, length=2, start=5,
                                 direction=1, role='', geom=g.line('67'))
                     ]
                ),
              rt.WaySegment(
                length=3, start=11,
                ways=[rt.BaseWay(osm_id=3, tags={}, length=3, start=11,
...
def test_oneway_reversed_between_twoways(grid):
    ...
    assert route == rt.RouteSegment(
        ...
        main=[rt.WaySegment(
                length=2, start=0,
                ways=[rt.BaseWay(osm_id=1, tags={}, length=2, start=0,
                                 direction=0, role='', geom=g.line('123'))
                     ]
                ),
              rt.WaySegment(
                length=2, start=2,
                ways=[rt.BaseWay(osm_id=9, tags={}, length=1, start=2,
                                 direction=1, role='', geom=g.line('34')),
                      rt.BaseWay(osm_id=8, tags={}, length=1, start=3,
                                 direction=1, role='', geom=g.line('45'))
                     ]
                ),
              rt.WaySegment(
                length=2, start=4,
                ways=[rt.BaseWay(osm_id=2, tags={}, length=2, start=4,
