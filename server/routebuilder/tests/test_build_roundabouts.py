        ...
        main=[rt.WaySegment(
              ...
              rt.SplitSegment(
                ...
                forward=[rt.WaySegment(
                            length=6, start=5,
                            ways=[rt.BaseWay(osm_id=2, tags={}, length=6, start=5,
...
def test_roundabout_beginning(grid, l2):
    ...
    assert route == rt.RouteSegment(
        ...
        main=[rt.SplitSegment(
                ...
                forward=[rt.WaySegment(
                            length=9, start=0,
                            ways=[rt.BaseWay(osm_id=2, tags={}, length=9, start=0,
                ...
                backward=[rt.WaySegment(
                            length=3, start=0,
                            ways=[rt.BaseWay(osm_id=2, tags={}, length=3, start=0,
              ...
              rt.WaySegment(
                length=5, start=9,
                ways=[rt.BaseWay(osm_id=3, tags={}, length=5, start=9,
                                 direction=0, role='', geom=g.line('49')
                                 )
                     ]
                )
    ...
    assert route == rt.RouteSegment(
        ...
        main=[rt.WaySegment(
              ...
              rt.SplitSegment(
                ...
                forward=[rt.WaySegment(
                            length=3, start=5,
                            ways=[rt.BaseWay(osm_id=2, tags={}, length=3, start=5,
                ...
                backward=[rt.WaySegment(
                            length=9, start=5,
                            ways=[rt.BaseWay(osm_id=2, tags={}, length=9, start=5,
...
def test_roundabout_with_approaches(grid):
    ...
    assert route == rt.RouteSegment(
        ...
        main=[rt.WaySegment(
                length=1, start=0,
                ways=[rt.BaseWay(osm_id=1, tags={}, length=1, start=0,
              ...
              rt.SplitSegment(
                ...
                forward=[rt.WaySegment(
                            length=2, start=1,
                            ways=[rt.BaseWay(osm_id=3, tags={}, length=2, start=1,
                         ...
                         rt.WaySegment(
                            length=2, start=3,
                            ways=[rt.BaseWay(osm_id=4, tags={}, length=2, start=3,
                         ...
                         rt.WaySegment(
                            length=2, start=5,
                            ways=[rt.BaseWay(osm_id=6, tags={}, length=2, start=5,
                ...
                backward=[rt.WaySegment(
                            length=2, start=1,
                            ways=[rt.BaseWay(osm_id=2, tags={}, length=2, start=1,
                          ...
                          rt.WaySegment(
                            length=2, start=5,
                            ways=[rt.BaseWay(osm_id=5, tags={}, length=2, start=5,
              ...
              rt.WaySegment(
                length=1, start=7,
                ways=[rt.BaseWay(osm_id=7, tags={}, length=1, start=7,
        ...
        main=[rt.WaySegment(
              ...
              rt.SplitSegment(
                ...
                forward=[rt.WaySegment(
                         ...
                         rt.WaySegment(
                            length=2, start=3,
                            ways=[rt.BaseWay(osm_id=3, tags={}, length=2, start=3,
              ...
              rt.WaySegment(
                length=1, start=5,
                ways=[rt.BaseWay(osm_id=4, tags={}, length=1, start=5,
    ...
    assert route == rt.RouteSegment(
        ...
        main=[rt.WaySegment(
              ...
              rt.SplitSegment(
                ...
                forward=[rt.WaySegment(
                            length=1, start=1,
                            ways=[rt.BaseWay(osm_id=2, tags={}, length=1, start=1,
                         ...
                         rt.WaySegment(
                            length=2, start=2,
                            ways=[rt.BaseWay(osm_id=3, tags={}, length=2, start=2,
                         ...
                         rt.WaySegment(
                            length=1, start=4,
                            ways=[rt.BaseWay(osm_id=5, tags={}, length=1, start=4,
                ...
                backward=[rt.WaySegment(
                          ...
                          rt.WaySegment(
                            length=2, start=2,
                            ways=[rt.BaseWay(osm_id=4, tags={}, length=2, start=2,
              ...
              rt.WaySegment(
                length=1, start=5,
                ways=[rt.BaseWay(osm_id=6, tags={}, length=1, start=5,
                                 direction=0, role='', geom=g.line('69')
                                )
                     ])
            ])
